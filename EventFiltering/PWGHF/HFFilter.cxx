...
struct HfFilter { // Main struct for HF triggers
  ...
  Configurable<LabeledArray<double>> cutsXiBachelor
  {
    "cutsXiBachelor", {cutsCharmBaryons[0], 1, 4, labelsEmpty, labelsColumnsCharmBaryons, "Selections for charm baryons (Xi+Pi and Xi+Ka)"};
